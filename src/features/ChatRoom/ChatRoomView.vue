  ...
  <div class="container mx-auto p-4">
    ...
    <div v-else>
      <div v-if="activeTab === 'important' && !isInstitution">
        <div v-for="institution in notifications" :key="institution.id" class="mb-2">
          <div
            class="bg-white shadow-md rounded-lg p-4 flex justify-between items-center cursor-pointer"
            @click="toggleInstitution(institution.id)"
          >
      ...
      institutionalNotifications: [
        {
          ...
          name: "UNICEF",
          avatar:
            "https://th.bing.com/th/id/R.f789c45e7c6126656eac8028cb7db28a?rik=BRNVQ2vHUkbikA&riu=http%3a%2f%2fwww.clipartbest.com%2fcliparts%2feTM%2fAM4%2feTMAM4bAc.jpg&ehk=uLmGOx7GjYzASsrK%2fRwkEzQimqj%2fXK4qoDBYGYrJNTg%3d&risl=&pid=ImgRaw&r=0",
          isVisible: false,
          notifications: [
            {
              id: 1,
              avatar: "https://example.com/avatar1.jpg",
              title: "UNICEF Message 1",
              content_en: "This is a new notification for you guys pay attention please",
              time: "19m ago",
              isNew: true,
            },
            {
        ...
        },
        {
          ...
          name: "Government",
          avatar:
            "https://th.bing.com/th/id/R.8d50d8096e12fcfa504b0da1db39d8e0?rik=J7u%2fJGi6OGhaGQ&pid=ImgRaw&r=0&sres=1&sresct=1",
          isVisible: false,
          notifications: [
            {
              id: 3,
              avatar: "https://example.com/avatar3.jpg",
              title: "Government Message 1",
              content_en: "This is a new notification for you guys pay attention please",
              time: "30m ago",
              isNew: true,
            },
